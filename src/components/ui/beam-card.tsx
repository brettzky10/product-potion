...
export function BeamCard({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg border bg-gradient-to-br from-pink-700/10 to-primary-foreground/10 p-10 md:shadow-xl backdrop-blur-sm",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex h-full w-full flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="h-16 w-16">
            {/* <Icons.openai /> */}
            <Image src="/images/site/crop-image.svg" alt="logo" width={40} height={40}/>
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} className="h-16 w-16">
            {/* <Icons.googleDrive /> */}
            <Image src="/images/site/kijiji2.png" alt="kijiji" width={40} height={40}/>
          </Circle>
          <Circle ref={div2Ref} className="h-16 w-16">
            {/* <Icons.googleDocs /> */}
            <Image src="/images/site/karrot-logo.png" alt="karrot" width={40} height={40}/>
          </Circle>
          <Circle ref={div3Ref} className="h-16 w-16">
            {/* <Icons.whatsapp /> */}
            <Image src="/images/site/craigslist2.png" alt="craigslist" width={40} height={40}/>
          </Circle>
          <Circle ref={div4Ref} className="h-16 w-16">
            {/* <Icons.messenger /> */}
            <Image src="/images/site/airbnb.png" alt="airbnb" width={40} height={40}/>
          </Circle>
          <Circle ref={div5Ref} className="h-16 w-16">
            {/* <Icons.notion /> */}
            <Image src="/images/site/facebook.png" alt="facebook" width={40} height={40}/>
          </Circle>
        </div>
      </div>
