  ...
  return (
    ...
    >
      <div className="space-y-4 w-full">
        ...
        <div className="grid w-full items-center gap-1.5">
          <Label htmlFor="isAvailableForPurchase">IsAvailable</Label>
          {/* <Input
            id="isAvailableForPurchase"
            placeholder="IsAvailable"
            type="toggle"
            
            value={productInfo.isAvailableForPurchase}
            onChange={handleChange}
          /> */}
                    <Checkbox
                                        checked={productInfo.isAvailableForPurchase}
                                        //@ts-ignore
        ...
        <div className="grid w-full items-center gap-1.5">
          ...
          <Input
            ...
            type="number"
            value={productInfo.priceInCents}
            onChange={handleChange}
          />
        </div>
        <div className="grid w-full items-center gap-1.5">
